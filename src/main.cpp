...
uint256 hashGenesisBlock("0x263235b8722f4823b3be758124640a91413cf71bf9215f15548fdc91058e9057");
...
const string strMessageMagic = "Billaume Signed Message:\n";
...
static const int64 nTargetTimespan = 7 * 24 * 60 * 60; // Billaume: 7 days
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal billaume miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Billaume", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xf8dccc88a7ca25c848921c27b5594ab3ba994332c0ebc008ab225fc06f7675ce");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Et sans Billaume";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1390674730; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1319602;

        if (fTestNet)
        {
            block.nTime    = 1390660094;
            block.nNonce   = 511837;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x8cb566d6d652e24592b0c2ad71cb6973ddd46eaed1193fbd2a05372680344fb9"));
