...
uint256 hashGenesisBlock("0x68f6283d61e7f8b6ae0965d8873743197c72e5f54a447c9977d714cfa45b5d9c");
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x725e43e3a6dffdef350dc311a428719ca6f8a589b17b1f26a9633d817629e75e");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1390747468; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 393;

        if (fTestNet)
        {
            block.nTime    = 1390745500;
            block.nNonce   = 193656;
        }
